...
public class ReceptionistLogin extends JFrame {
	...
	public static boolean validate(String First_name,String password){
		boolean status=false;
		try{
			Connection con=DB.getConnection();
			PreparedStatement ps=con.prepareStatement("select First_name, Password from Receptionist where First_name=? and password=?");
	...
	public ReceptionistLogin() {
		...
		JLabel lblAdminLoginForm = new JLabel("Receptionist Login Form");
