...
public class Success extends JFrame {
	...
	public Success() {
		...
		JLabel lblAdminSection = new JLabel("Guest Form");
		lblAdminSection.setFont(new Font("Tahoma", Font.PLAIN, 15));
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			GuestForm.main(new String[]{});
			frame.dispose();
			}
		});
		
		JButton btnViewLibrarian = new JButton("View Guests");
		btnViewLibrarian.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			ViewGuest.main(new String[]{});
			}
		});
		btnViewLibrarian.setFont(new Font("Tahoma", Font.PLAIN, 15));
		
		JButton btnDeleteLibrarian = new JButton("Delete Guest");
		btnDeleteLibrarian.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			DeleteGuest.main(new String[]{});
			frame.dispose();
			}
		});
